...
class Generator_gan(nn.Module):
    ...
    def __init__(self, d=128):
        ...
        self.deconv1 = nn.ConvTranspose2d(latent, d*8, 4, 1, 0)
        self.deconv1_bn = nn.BatchNorm2d(d*8)
        self.deconv2 = nn.ConvTranspose2d(d*8, d*4, 3, 1, 0)
        self.deconv2_bn = nn.BatchNorm2d(d*4)
        self.deconv3 = nn.ConvTranspose2d(d*4, d*2, 4, 1, 0)
        self.deconv3_bn = nn.BatchNorm2d(d*2)
        self.deconv4 = nn.ConvTranspose2d(d*2, d, 4, 2, 0)
        self.deconv4_bn = nn.BatchNorm2d(d)
        self.deconv5 = nn.ConvTranspose2d(d, 1, 3, 1, 0)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, d=128):
        ...
        # self.linear = nn.Conv2d(d*8, 1, 4, 1, 0)
